...
public class CustomerServiceTest extends AbstractTransactionRollbackTest {
    ...
    public void create() {
        // execute
        Customer customer = createCustomer(CUSTOMER_FIRST_NAME, CUSTOMER_LAST_NAME, CUSTOMER_POSTALCODE, CUSTOMER_HOUSENUMBER, CUSTOMER_EMAIL);
    ...
    private Customer createCustomer(String firstName, String lastName, String postalCode, String houseNumber, String email) {
